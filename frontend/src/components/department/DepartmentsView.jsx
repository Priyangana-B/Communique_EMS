...
import { coloumns, DepartmentButtons } from "../../utils/DepartmentHelper";
      ...
      try {
        ...
        if (response.data.success) {
          ...
          const data = await response.data.departments.map((dept) => ({
            ...
            action: (<DepartmentButtons _id={dept._id} onDeptDelete={onDeptDelete}/>),
          }));
    ...
    <div className="p-8">
      ...
      <div className="mb-10">
        ...
        <p className="mt-4 text-base text-[#776D8A]">
          Manage, edit and organize all departments within your organization.
        </p>
